...
- Create Angular project with ng: `ng new angularnetgradiotest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularnetgradiotest.client.esproj`).
